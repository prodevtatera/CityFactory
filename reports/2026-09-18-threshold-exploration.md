...
Generated: 2026-09-18T21:03:04.165789+00:00
...
OFFLINE WHAT-IF: threshold 0.3; original decisions unchanged.
...
Potential skipped calls: 4; Jev errors: 0; Astra errors: 0.
Correct against supplied labels: 12/12; human feedback labels: 0.
Always-review baseline correct: 8/12 (no classification API required).
Astra correct: 11/12; Astra false skips: 1.
Missed actionable events (false skips): 0; unnecessary reviews: 0.
Astra disagreements: 1/12 paired verdicts. Astra is a comparator, not ground truth.
Paired cost coverage: 12/12 events.
Astra-only baseline for priced pairs: $0.03160000.
Projected Jev + retained Astra calls for those pairs: $0.02212858.
Projected savings for those pairs: $0.00947142 (counterfactual, not realized).
